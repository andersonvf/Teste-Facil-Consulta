    ...
    <div class="center-screen">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form action="/finalizacao" style="margin: 5% 0px 0px 5%;">
                    <div class="form-group">
                        <label class="tituloInput" for="name">Especialidade Principal*</label>
                        <select v-model="formAtend.especialidades" id="tipoConsulta" required
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group-prepend">
                            <span style="background-color:#483698;color:#fff;font-weight:bold;"
                                class="input-group-text">R$</span>
                            <input required type="number" style="margin-left:-10px;" v-model="formAtend.valor"
                                id="dinheiro" class="form-control precoInput" placeholder="Valor" min="30" max="350">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="box-check">
                            <input name="check" id="checkboxPix" type="checkbox" class="checkbox"
                                style="margin-right:10px;">
                            <span id="checkboxPix">Pix</span>
                        </div>

                        <div class="box-check" style="margin-top:15px;">
                            <input name="checkboxDinheiro" id="checkboxDinheiro" type="checkbox" class="checkbox"
                                style="margin-right:10px;">
                            <span>Em dinheiro</span>
                        </div>

                        <div class="box-check" style="margin-top:15px;">
                            <input name="check" id="checkboxCartao" type="checkbox" class="checkbox"
                                style="margin-right:10px;" data-toggle="collapse" href="#collapseExample" role="button"
                                aria-expanded="false" aria-controls="collapseExample">
                            <span>Cartão de Crédito</span>
                            <div id="collapseExample" class="box-check-cartao collapse">
                                <br />
                                <span>Parcelamento em</span> <br /><br />
                                <input name="check" id="checkbox" type="checkbox" class="checkbox"
                                    style="margin-right:10px;">
                        ...
                        <div class="col-md-4">
                            <div class="progress" style="height: 25px;margin-top:30px;">
                                <div class="progress-bar" role="progressbar"
                                    style="width: 100%;background-color: rgb(72, 54, 152);" aria-valuenow="25"
                ...
                <img src="../../assets/imagens/img2.png" style="width:300px;height:300px;" class="rounded">
            </div>
        </div>
    </div>
